...
arg_parse.add_argument('-sign',help='Sign for overlay. Default is abs',nargs=1,default=['abs'])
...
def setOverlay(overlay):
	if ( args.sign[0] == 'abs' or args.sign[0] == 'pos' ):
	...
	if ( args.sign[0] == 'abs' or args.sign[0] == 'neg' ):
...
for hemi in ['lh','rh']:
	...
	#Add overlay
	brain.add_overlay(data,min=args.minmax[0],max=args.minmax[1],sign=args.sign[0],name='multi')
